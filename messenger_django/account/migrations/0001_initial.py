    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('sent', 'Sent'), ('not sent', 'Not Sent'), ('accepted', 'Accepted'), ('waiting', 'Waiting'), ('rejected', 'Rejected'), ('cancel', 'Cancel')], default='not sent', max_length=20)),
